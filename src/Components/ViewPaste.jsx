...
const ViewPaste = () => {
  ...
  // ✅ Show fallback if paste not found (like on direct refresh)
  if (!paste) {
    return (
      <div className="w-full min-h-screen flex items-center justify-center text-white bg-gray-900">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4">Paste Not Found</h2>
          <p className="text-gray-400">It may have been deleted or you're accessing directly without saved data.</p>
        </div>
      </div>
    );
  }
